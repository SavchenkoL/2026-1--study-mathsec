...
Мы установили приложение LaTex, чтобы работать в нем с лабораторными задачами.
Установка длилась около 2-4 часов.
В результате мы скачали папку с рабочим столом, приложением для установки библиотек и тд.
